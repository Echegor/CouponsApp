package com.archelo.shoprite.coupons.urls;
...
public class AzureUrls {
    ...
    public static final String COUPONS_METADATA = "https://stagingcouponswest.azure-mobile.net/tables/cp_query_read_metadata";

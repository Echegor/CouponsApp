...
public class VerifySignInRequest extends StringRequest {
    ...
    public VerifySignInRequest(CookieStore cookieStore, LoginStatus loginStatus, String request, int method, String url, Response.Listener<String> listener, Response.ErrorListener errorListener) {
